 ...
 * @since 100.0.2
 */
class SearchDataProvider extends \Magento\Catalog\Ui\DataProvider\Product\ProductDataProvider
{
    /**
     * Get data
     *
    ...
    public function getData()
    {
        ...
        ->where("`e`.`entity_id` NOT IN (SELECT `product_id` FROM `$table` WHERE `featured_id` = $parent_id)");
